    ...
    <>
      <div>
        <Card className="group overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-1 bg-linear-to-br from-white to-gray-50">
          <div className="relative h-72 ">
            ...
            <div className="absolute top-3 left-3 flex items-center gap-2">
              ...
              {hero.status === "Active" ? (
                ...
                <Badge
                  variant="secondary"
                  className="text-xs bg-white/90 text-red-700"
                >
                  {hero.status}
                </Badge>
              )}
          ...
          <CardHeader className="py-4 z-10 bg-gray-100/50 backdrop-blur-sm relative top-1 group-hover:-top-1 transition-all duration-300">
